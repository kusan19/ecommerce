...
<div class="body-content">
	...
	<h1>@if(session()->get('language') == 'language') {{ $blogpost->post_title }} @else {{ $blogpost->post_title }} @endif</h1>
	...
	<p> @if(session()->get('language') == 'language') {!!  $blogpost->post_details !!} @else {!!  $blogpost->post_details  !!} @endif
	</p>
...
@foreach($blogcategory as $category)
	    	 <ul class="list-group">
    <a href="{{ url('blog/category/post/'.$category->id) }}"><li
        class="list-group-item">@if(session()->get('language') == 'language') {{ $category->blog_category_name }}
        @else {{ $category->blog_category_name }} @endif</li></a>
