...
<div class="body-content outer-top-xs">
 ...
 @foreach($categories as $category)
	...
	<div class="accordion-heading"> <a href="#collapse{{ $category->id }}" data-toggle="collapse" class="accordion-toggle collapsed">
		@if(session()->get('language') == 'language') {{ $category->category_name }} @else {{ $category->category_name}} @endif </a> </div>
	<!-- /.accordion-heading -->
   ...
   @foreach($subcategories as $subcategory)
	    <ul>
	      <li><a href="{{ url('subcategory/product/'.$subcategory->id.'/'.$subcategory->subcategory_slug ) }}">
	      	@if(session()->get('language') == 'language') {{ $subcategory->subcategory_name }} @else {{ $subcategory->subcategory_name }} @endif</a></li>
      ...
      <div class="product">
        ...
        <div class="product-info text-left">
          <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug) }}">
          	@if(session()->get('language') == 'language') {{ $product->product_name }} @else {{ $product->product_name }} @endif</a></h3>
...
<div class="product-price"> <span class="price"> ${{ $product->discount_price }} </span> <span class="price-before-discount">$ {{ $product->selling_price }}</span> </div>
            ...
            <div class="description m-t-10">
            	@if(session()->get('language') == 'language') {{ $product->short_descp }} @else {{ $product->short_descp }} @endif</div>
            <div class="cart clearfix animate-effect">
              <div class="action">
                <ul class="list-unstyled">
                  <li class="add-cart-button btn-group">
