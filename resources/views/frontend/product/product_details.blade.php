...
<!-- ============================================== Testimonials: END ============================================== -->
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
       ...
       @if(session()->get('language') == 'language')  {{ $product->product_name }} @else {{ $product->product_name }} @endif
        ...
        @if(session()->get('language') == 'language')  {{ $product->short_descp }} @else {{ $product->short_descp }} @endif
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">
                @if(session()->get('language') == 'language')  {!! $product->long_descp !!} @else {!! $product->long_descp !!} @endif</p>
									</div>
								</div><!-- /.tab-pane -->
