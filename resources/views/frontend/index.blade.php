...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
    ...
    <div class="image"> <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug) }}">
        ...
        >@if(session()->get('language') == 'language') {{ $product->product_name }} @else {{ $product->product_name }} @endif
                                </a></h3>
 ...
 @if(session()->get('language') == 'language') {{ $product->product_name }} @else {{ $product->product_name }} @endif
         ...
         @endif
          ...
          data-target="#exampleModal" id="{{ $product->id }}" onclick="productView(this.id)"> <i class="fa fa-shopping-cart"></i> </button>
                ...
                <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}"
                 onclick="addToWishList(this.id)"> <i class="fa fa-heart"></i> </button>
                                  ...
                                  <li class="lnk"> <a data-toggle="tooltip" class="add-to-cart"
                                    href="detail.html" title="Compare"> <i class="fa fa-signal" aria-hidden="true"></i> </a> </li>
                                </ul>
                              </div>
                              <!-- /.action -->
                            </div>
...
<!-- ============================================== skip_product_0 PRODUCTS ============================================== -->
  ...
  @if(session()->get('language') == 'language') {{$skip_category_0->category_name}} @else {{$skip_category_0->category_name}} @endif
            </h3>
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
@if(session()->get('language') == 'language') {{ $product->product_name }} @else {{ $product->product_name }} @endif
       ...
       <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishList(this.id)">
        <i class="fa fa-heart"></i> </button>
          ...
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">
  @if(session()->get('language') == 'language') {{$skip_category_1->category_name}} @else {{$skip_category_1->category_name}} @endif
            </h3>
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
@if(session()->get('language') == 'language') {{ $product->product_name }} @else {{ $product->product_name }} @endif
       ...
       <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishList(this.id)">
        <i class="fa fa-heart"></i> </button>
   <li class="lnk"> <a data-toggle="tooltip" class="add-to-cart" href="detail.html" title="Compare"> <i class="fa fa-signal" aria-hidden="true"></i>
</a> </li>
                            </ul>
                          </div>
                          <!-- /.action -->
          ...
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">
  @if(session()->get('language') == 'language') {{$skip_brand_1->brand_name}} @else {{$skip_brand_1->brand_name}} @endif
            </h3>
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
@if(session()->get('language') == 'language') {{ $product->product_name }} @else {{ $product->product_name }} @endif
    ...
    <li class="lnk"> <a data-toggle="tooltip" class="add-to-cart" href="detail.html" title="Compare">
       ...
       <h3 class="name"><a href="#">@if(session()->get('language') == 'language') {{ $blog->post_title }} @else {{ $blog->post_title }} @endif</a></h3>
       <span class="info">{{ Carbon\Carbon::parse($blog->created_at)->diffForHumans()  }}</span>
        <p class="text">@if(session()->get('language') == 'language') {!! Str::limit($blog->post_details, 100 )  !!} @else {!! Str::limit($blog->post_details, 100 )  !!} @endif</p>
